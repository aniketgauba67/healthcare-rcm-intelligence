...
> source commit `01b1a623`, with `git_tree_dirty=false`. The public API and
> Streamlit UI were runtime and visually re-verified on 2026-08-06, including the
> corrected `sim_` markers. Formal QA re-acceptance of this rebuilt artifact is
> still outstanding. Phase 5 acceptance on 2026-08-01 covered the superseded
> bundle `66456ebf`, which a later audit found had shipped simulated columns
> without their `sim_` marker. The hosted services are portfolio-scale, not
> production-grade or always-on.
...
production-grade or always-on. It serves the current `559022e2` bundle, whose
deployment has been re-verified but whose formal QA re-acceptance remains open.
...
- Final DuckDB bundle generated from clean source SHA `01b1a623b22a5d3295087ace8995025ced0d462d`, with SHA-256 `559022e2fc27461fb874294eca1a6ba39149367afe7b2e49f9b43c2ccc7e8896` and `git_tree_dirty=false`. Regenerated by the bundle-column `sim_` marker rename; the earlier QA-accepted artifact was `ab2aa415` / `66456ebf`. The rebuild is live and was runtime and visually re-verified on 2026-08-06, but formal QA re-acceptance remains outstanding
...
`559022e2`, as confirmed by the live API `/ready` response on 2026-08-06. The
public dashboard was also visually re-verified with the corrected `sim_` markers.
This deployment verification is not a formal QA re-acceptance of the rebuilt
artifact; the 2026-08-01 acceptance applied to superseded bundle `66456ebf`.
...
`559022e2fc27461fb874294eca1a6ba39149367afe7b2e49f9b43c2ccc7e8896`.
...
source SHA `01b1a623b22a5d3295087ace8995025ced0d462d` and records
`git_tree_dirty=false`. Independent artifact QA passed on the previous
artifact (`ab2aa415` / `66456ebf`); this rebuild carries the `sim_` marker
rename. It is live and was runtime and visually re-verified on 2026-08-06, but
formal QA re-acceptance remains pending.
