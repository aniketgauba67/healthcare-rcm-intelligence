...
- Final DuckDB bundle generated from clean source SHA `01b1a623b22a5d3295087ace8995025ced0d462d`, with SHA-256 `559022e2fc27461fb874294eca1a6ba39149367afe7b2e49f9b43c2ccc7e8896` and `git_tree_dirty=false`. Regenerated by the bundle-column `sim_` marker rename; the earlier QA-accepted artifact was `ab2aa415` / `66456ebf`, and this rebuild has not yet been re-accepted or re-validated on the hosted demo
...
rename and is pending re-acceptance.
