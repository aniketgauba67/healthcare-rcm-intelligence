...
NON_OUTPUT_TREES: dict[str, str] = {
    ...
    ".claude": "Agent tooling, and — load-bearing — `.claude/worktrees/` holds full "
    "checkouts of this repository. Without this exclusion, a scan from the primary "
    "checkout reports every OTHER worktree's artifacts as sitting outside a published "
    "root, because they sit under `.claude/worktrees/<branch>/artifacts/` rather than "
    "`artifacts/`. Each worktree checks its own tree.",
    ...
    # The warehouse's INPUT and STAGING tiers. §5 gives `data/` to data-engineer and
    ...
    "data/raw": "Raw CMS source files (CLAUDE.md §3.6): never modified, never "
