...
def _save_figure(fig, path: pathlib.Path) -> pathlib.Path:  # noqa: ANN001
    ...
    `docs/model_card.md` and its warning are nowhere nearby. CLAUDE.md §1 has no
...
def write_provenance_readme(
    ...
    Two of these files are the cases CLAUDE.md names outright: `slice_payer.csv`
...
wherever they appear (CLAUDE.md §3). **No real patient, provider, payer or
