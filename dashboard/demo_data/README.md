...
Built from commit `fea27b680c6c720ce5ac3f2641b133d00de68333` (tree dirty) at 2026-07-30T17:00:56.652232+00:00 by `make demo-extract`.
...
|---|---|---:|---|
| `demo_build_info` | DERIVED | 1 | one row — the build stamp of this bundle |
| `demo_manifest` | DERIVED | 14 | one row per dataset in this bundle |
